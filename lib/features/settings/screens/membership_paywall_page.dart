...
class _MembershipPaywallPageState extends State<MembershipPaywallPage>
  ...
  // ── billing ───────────────────────────────────────────────────────────────
  Future<void> _loadBillingState({bool silent = false}) async {
  ...
  Future<void> _purchasePrimaryPlan() async {
    ...
    await _applyMembershipChange(
      () async {
        ...
        await _loadBillingState(silent: true);
  ...
  Widget _buildHeroHeader(ColorScheme scheme, bool isDark) {
    ...
    final gradTop =
        isDark ? const Color(0xFF0A1628) : const Color(0xFF0969DA);
    final gradMid =
        isDark ? const Color(0xFF0D2340) : const Color(0xFF1A4FA3);
    final gradBot =
        isDark ? const Color(0xFF122040) : const Color(0xFF344BCF);
    ...
    return _entrance(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: AppTheme.primaryBlue.withValues(alpha: isDark ? 0.25 : 0.30),
              blurRadius: 20,
    ...
    return _entrance(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: AppTheme.shadow(AppTheme.primaryBlue, blur: 16, opacity: 0.08),
        ),
        padding: const EdgeInsets.all(20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget build(BuildContext context) {
    ...
    final isTrialActive =
        _activeProEntitlement?.periodType == PeriodType.trial;
