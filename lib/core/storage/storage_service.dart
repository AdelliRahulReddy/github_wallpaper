...
class StorageService {
  ...
  static Future<void> setAppUserId(String? userId) async {
    ...
    if (nextUserId == null || nextUserId.isEmpty) {
      await prefs.remove(AppConstants.keyAppUserId);
      return;
    }
  ...
  static Future<void> setHasAuthError(bool v) async =>
      (await init()).setBool(AppConstants.keyHasAuthError, v);
  static bool hasAuthError() =>
      _s?.getBool(AppConstants.keyHasAuthError) ?? false;
