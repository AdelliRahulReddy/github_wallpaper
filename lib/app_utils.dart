...
class ValidationUtils {
  ...
  static final _tokenRegex =
      RegExp(r'^(ghp_|github_pat_|gho_|ghu_|ghs_|ghr_)[a-zA-Z0-9_]{10,}$');
  ...
  static String? token(String? v) =>
      (v == null || !_tokenRegex.hasMatch(v.trim())) ? 'Invalid token' : null;
...
// Keep these unchanged — used by setup_page.dart
  ...
  static const systemClockArea = 'SYSTEM CLOCK AREA';
  static const gestureArea = 'GESTURE AREA';
  static const previewFor = 'Preview for';
...
class AppConstants {
  ...
  static const int pendingRefreshDebounceMinutes = 2,
      ...
      resumeSyncThresholdMinutes = 30,
      backgroundSyncThresholdHours = 1;
